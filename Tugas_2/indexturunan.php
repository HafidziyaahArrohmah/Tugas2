...
$db = new Database();
//membuat objek (instansi) dari kelas mahasiswaTurunan dengan objek Database
$nilaiturunanmhs = new mahasiswaTurunan($db);

//menetapkan kriteria untuk filter data (nama = Diata Syaifani)
$kriteria ="Nama = 'Dita Syaifani'";
//mengambil data mahasiswa turunan berdasarkan kriteria
$data_mhsturunan = $nilaiturunanmhs->tampilData($kriteria);
?>
<!DOCTYPE html>
...
<nav class="navbar navbar-expand-lg navbar-light navbar-custom">
    ...
    <div class="container mt-3">
      <table class="table table-striped">
        ...
        <?php
        foreach($data_mhsturunan as $row) { //foreach untuk menampilkan data
        ?> 
        <tr>
